...
public class Chart {
    ...
    public void ExecCHART() {
        ...
        this.game.con.printf(out, game.getCoordinateString(0, 0), game.getCoordinateString(0, 1),
                ...
                game.getCoordinateString(2, 0), game.getCoordinateString(2, 1), game.getCoordinateString(2, 2),
                game.getCoordinateString(2, 3), game.getCoordinateString(2, 4), game.getCoordinateString(2, 5),
                game.getCoordinateString(2, 6), game.getCoordinateString(2, 7),
                game.getCoordinateString(3, 0), game.getCoordinateString(3, 1), game.getCoordinateString(3, 2),
                game.getCoordinateString(3, 3), game.getCoordinateString(3, 4), game.getCoordinateString(3, 5),
                ...
                game.getCoordinateString(5, 0), game.getCoordinateString(5, 1), game.getCoordinateString(5, 2),
                game.getCoordinateString(5, 3), game.getCoordinateString(5, 4), game.getCoordinateString(5, 5),
                game.getCoordinateString(5, 6), game.getCoordinateString(5, 7),
                game.getCoordinateString(6, 0), game.getCoordinateString(6, 1), game.getCoordinateString(6, 2),
                game.getCoordinateString(6, 3), game.getCoordinateString(6, 4), game.getCoordinateString(6, 5),
